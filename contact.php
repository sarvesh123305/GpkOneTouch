            ...
            <div class="col-md-6">
               <form id="request" class="main_form">
                  <div class="row">
                     ...
                     <div class="col-md-10">
                        <button type="submit" name="btnsend" class="send_btn">Send</button>
            ...
            <div class="col-md-4">
               <div class="map_main">
                  <div class="map-responsive">
                     <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3821.773086574556!2d74.25539691486672!3d16.688234688501105!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3bc1002e3f732899%3A0xbd46c7b4413d3652!2sGovernment%20Polytechnic!5e0!3m2!1sen!2sin!4v1646937205513!5m2!1sen!2sin" width="400" height="400" style="border:0;" allowfullscreen="" loading="lazy"></iframe>
                  </div>
               </div>
            </div>
         </div>
...
if (isset($_POST["btnsend"])) {
   ...
   if (!empty($_POST['Name']) && !empty($_POST['Email'])  && !empty($_POST['Phone']) && !empty($_POST['feedback'])) {
      ...
      $query = "insert into contact (name,email,phone,feedback) values('$name','$email','$phone','$feed')";
